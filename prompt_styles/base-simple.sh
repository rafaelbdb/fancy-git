...
fancygit_color_blue="\\[\\e[34m\\]"
fancygit_color_orange="\\033[95;38;5;214m"
fancygit_color_light_blue="\\033[95;38;5;45m"
fancygit_color_light_green="\\[\\e[92m\\]"
fancygit_color_light_yellow="\\[\\e[93m\\]"
fancygit_color_light_red="\\[\\e[91m\\]"
fancygit_color_reset="\\[\\e[39m\\]"
fancygit_bg_color_white="\\[\\e[107m\\]"
fancygit_bg_color_blue="\\[\\e[44m\\]"
fancygit_bg_color_light_green="\\[\\e[102m\\]"
fancygit_bg_color_light_yellow="\\[\\e[103m\\]"
fancygit_bg_color_reset="\\[\\e[49m\\]"

fancygit_icon_stash=" ${fancygit_color_light_yellow}${fancygit_icon_stash}${fancygit_color_reset} "
fancygit_icon_untracked_files=" ${fancygit_color_light_yellow}${fancygit_icon_untracked_files}${fancygit_color_reset} "
fancygit_icon_changed_files=" ${fancygit_color_light_green}+${fancygit_color_light_red}-${fancygit_color_reset} "
fancygit_icon_added_files=" ${fancygit_color_light_green}${fancygit_icon_added_files}${fancygit_color_reset} "
fancygit_icon_push=" ${fancygit_color_light_green}${fancygit_icon_push}${fancygit_color_reset} "
fancygit_icon_local_branch=" ${fancygit_color_light_green}${fancygit_icon_local_branch} "
fancygit_icon_merged_branch=" ${fancygit_color_light_yellow}${fancygit_icon_merged_branch}${fancygit_color_reset} "
...
fancygit_repo_status_section=" ${fancygit_icon_virtualvenv}${fancygit_icon_stash}${fancygit_icon_untracked_files}${fancygit_icon_changed_files}${fancygit_icon_added_files}${fancygit_icon_push}"
fancygit_repo_status_section=$(echo "$fancygit_repo_status_section" | sed -r 's#\s+# #g')
...
fancygit_git_branch_icon=""

if __fancygit_is_only_local_branch; then
    fancygit_git_branch_icon="${fancygit_icon_local_branch}"
fi

if ! [ -z "$fancygit_git_merged_branch" ]; then
    fancygit_git_branch_icon="${fancygit_icon_merged_branch}"
fi
